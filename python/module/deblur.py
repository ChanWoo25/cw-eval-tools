...
def main():
    ...
    # img = cv.imread("/data/datasets/dataset_project/8th_loop_hard/1685357910170032128.png", cv.IMREAD_GRAYSCALE)
    img = cv.imread("/data/datasets/dataset_project/8th_loop_hard/1685357895745525024.png", cv.IMREAD_GRAYSCALE)
