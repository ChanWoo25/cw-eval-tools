...
def eval_n_plot(out_fn: Path, gt_fn:Path, png_fn: Path):
...
if __name__ == '__main__':
    ...
    # for method in ['correlation', 'haste_correlation', 'haste_correlation_star', 'haste_difference', 'haste_difference_star']:
    #     out_fn = Path('/data/results/event_feature_tracking/case_a/%s/eval.txt' % method)
    #     png_dir = Path('./%s/%s' % (dataset, method))
    #     os.makedirs(png_dir, exist_ok=True)
    #     png_fn = png_dir / 'errors.png'
    #     eval_n_plot(out_fn, gt_fn, method)
